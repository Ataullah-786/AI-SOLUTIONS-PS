...
- **Excel output.** The agent generates CSV text, not `.xlsx` binary. If the input is Excel,
  deliver the cleaned file as CSV or add a conversion step inside the flow.
